...
// Fetch all pupils for Year 6(class_id = 7)
$sql = "SELECT pupil_id, name, address, medical_info FROM pupils WHERE class_id = 7";
...
<head>
    ...
    <title>Year Six - St. Alphonsus Primary School</title>
...
<div class="container mt-5">
    <h2 class="text-center">Year Six Pupils</h2>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='4' class='text-center'>No pupils found in Year Six.</td></tr>";
            }
            ?>
        </tbody>
    </table>
