...
// Fetch all pupils for Year 3 (class_id = 4)
$sql = "SELECT pupil_id, name, address, medical_info FROM pupils WHERE class_id = 4";
...
<head>
    ...
    <title>Year Three - St. Alphonsus Primary School</title>
...
<div class="container mt-5">
    <h2 class="text-center">Year Three Pupils</h2>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='4' class='text-center'>No pupils found in Year Three.</td></tr>";
            }
            ?>
        </tbody>
    </table>
