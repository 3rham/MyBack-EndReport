...
<head>
    ...
    <title>Home - St. Alphonsus Primary School</title>
    ...
    <div class="container main-container">
        <div class="row w-100">
            <div class="col-md-6 content">
                <img src="logo9.png" alt="School Logo" class="logo">
                <h1>Welcome to St. Alphonsus Primary School</h1>
                <p>Efficient school management system for pupils, teachers, and parents.</p>
                <a href="add_pupil.php" class="btn btn-dark">Add Pupil Now</a>
            </div>
            <div class="col-md-6 image-section">
                <img src="graduation5.jpg" alt="Graduation Ceremony">
            </div>
        </div>
    </div>
