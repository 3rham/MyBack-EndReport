...
// Fetch all pupils for Reception Year (class_id = 1)
$sql = "SELECT pupil_id, name, address, medical_info FROM pupils WHERE class_id = 1";
...
<head>
    ...
    <title>Reception Year - St. Alphonsus Primary School</title>
...
<div class="container mt-5">
    <h2 class="text-center">Reception Year Pupils</h2>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='4' class='text-center'>No pupils found in Reception Year.</td></tr>";
            }
            ?>
        </tbody>
    </table>
