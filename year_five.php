...
// Fetch all pupils for Year 5(class_id = 6)
$sql = "SELECT pupil_id, name, address, medical_info FROM pupils WHERE class_id = 6";
...
<head>
    ...
    <title>Year 5 - St. Alphonsus Primary School</title>
...
<div class="container mt-5">
    <h2 class="text-center">Year Five Pupils</h2>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='4' class='text-center'>No pupils found in Year Five.</td></tr>";
            }
            ?>
        </tbody>
    </table>
